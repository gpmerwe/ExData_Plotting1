...
png(filename="C:/Coursera/4 Graphs/Week 1/ExData_Plotting1/plot4.png", width = 480, height = 480, units = "px")
par(mfrow= c(2,2), mar=c(4,4,2,2))
# Graph 1
with(my_data, plot(DateTime, Global_active_power, type="n", ylab="Global Active Power"))
with(my_data, lines(DateTime, Global_active_power))

# Graph 2
with(my_data, plot(DateTime, Voltage, type="n", ylab="Voltage"))
...
# Graph 4
with(my_data, plot(DateTime, Global_reactive_power, type="n", ylab="Global_reactive_power"))
